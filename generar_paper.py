...
METODOLOGIA = (
    ...
    "• 3 nodos API Flask (puertos 5000–5002) representando nodos geográficos.\n"
    "• 3 instancias HAPI FHIR R4 (puertos 8080–8082) por nodo.\n"
    "• 3 instancias CouchDB (puertos 5984–5986) para almacenamiento documental.\n"
